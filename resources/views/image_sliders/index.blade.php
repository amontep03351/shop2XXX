                        ...
                        <table id="sortable-table" class="min-w-full divide-y divide-gray-200 white:divide-gray-700">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Title (TH)</th>
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Description (EN)</th>
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Description (TH)</th> 
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($imageSliders as $imageSlider) 
                                    <tr data-id="{{ $imageSlider->id }}" class="sortable-row hover:bg-gray-100 white:hover:bg-gray-700 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 white:text-gray-400">{{ $imageSlider->title_th }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 white:text-gray-400">{{ $imageSlider->description_en }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 white:text-gray-400">{{ $imageSlider->description_th }}</td> 
